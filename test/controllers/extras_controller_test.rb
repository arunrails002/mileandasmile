...
class ExtrasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create extra" do
    assert_difference('Extra.count') do
      post extras_url, params: { extra: { mission: @extra.mission, ourteam: @extra.ourteam, vision: @extra.vision } }
    end
  ...
  test "should update extra" do
    patch extra_url(@extra), params: { extra: { mission: @extra.mission, ourteam: @extra.ourteam, vision: @extra.vision } }
